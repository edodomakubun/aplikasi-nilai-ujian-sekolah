const API_URL = 'https://script.google.com/macros/s/AKfycbyJZpDageKRULNrV-jhIxO8E0723Fm4r2Vosajnp5akEWm01qebrYXA2DeqXNtX8Z2iIA/exec';
...
export const api = {
  ...
  deleteStudent: (data) => fetchAPI('deleteStudent', 'POST', data),
